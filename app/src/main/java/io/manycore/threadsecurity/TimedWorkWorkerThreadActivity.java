...
public class TimedWorkWorkerThreadActivity extends AppCompatActivity {
    ...
    private void experimentsMT() {
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                Log.i("Manycore::log", "TimedWorkWorkerThreadActivity started root run()");
                ...
                Log.i("Manycore::log", "TimedWorkWorkerThreadActivity out of the loop, totalRun:" + totalRun);
                Future<?> fut = MyApplication.executorService.submit(new Runnable() {
                    public void run() {
                        Log.i("Manycore::log", "TimedWorkWorkerThreadActivity release");
                        sem.release();
                    }
                });

                try {
                    Log.i("Manycore::log", "TimedWorkWorkerThreadActivity waitfor sem");
                    sem.acquire();
                } catch (InterruptedException e) {
                ...
                Log.i("Manycore::log", "TimedWorkWorkerThreadActivity time ms: " + totalTimeMs);
    ...
    private void experimentsGUI() {
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                    ...
                    MyApplication.executorService.submit(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                TimedWorkWorkerThreadActivity.this.runOnUiThread(new Runnable() {
                                    public void run() {
                                        updateGrid(t);
                                        nbrOnWorkerQueue.decrementAndGet();
                                    }
                ...
                Log.i("Manycore::log", "TimedWorkGuiThreadActivity out of the loop, totalRun:" + totalRun);
